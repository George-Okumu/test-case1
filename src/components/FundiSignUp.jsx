...
const FundiSignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-100 font-roboto">
...
/>
      ...
      {step === 1 && (
        <>
          <h2 className="text-2xl font-bold mb-6 text-gray-800 mt-27">Select a skill</h2>
  <select className="w-70 max-w-xs px-3 py-3 border border-gray-400 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-blue-700 cursor-pointer">
  <option value="" disabled selected className="bg-white text-black">Choose a skill</option>
  ...
  <option value="fundi_wa_nyumba" className="bg-white text-black">Fundi wa nyumba</option>
  <option value="fundi_wa_mjengo" className="bg-white text-black">Fundi wa Mjengo</option>
</select>
          ...
          <div className="flex justify-between gap-4 mt-6 w-full">
            ...
            type="button"
              onClick={prevStep} 
              className="bg-[rgb(0,0,122)] px-5 py-3 rounded-md text-white w-full transition hover:bg-[rgb(0,0,180)]"
            >
              Back
            </button>
            <button 
            type="button"
              onClick={nextStep} 
              className="bg-[rgb(0,0,122)] text-white px-5 py-3 rounded-md w-full transition hover:bg-[rgb(0,0,180)]"
            >
              Next
            </button>
          </div>
      ...
      {step === 2 && (
 <div className="flex flex-col items-center m-25 w-full text-center p-6 bg-white rounded-lg shadow-md max-w-md">
 {/* Title */}
...
{step === 3 && (
  <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg mx-auto mt-12">
    ...
    <div className="mt-8 flex justify-between">
      ...
      type="button"
        onClick={prevStep}
        className="py-2 px-6 bg-gray-400 text-white rounded-lg hover:bg-gray-500 transition-all duration-200"
      >
        Back
      </button>
      <button
      type="button"
        onClick={nextStep}
        className="py-2 px-6 bg-[rgb(0,0,122)] text-white rounded-lg hover:bg-[rgb(0,0,180)] transition-all duration-200"
      >
        Next
      </button>
    </div>
...
{step === 6 && (
  <div className="max-w-lg mx-auto bg-white p-8 rounded-2xl shadow-lg m-10">
    {/* Title */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      <div className="relative w-full">
        <select className="border p-3 pr-10 rounded-lg w-full appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500">
          <option>ID Type</option>
          <option>National ID</option>
          <option>Passport</option>
          <option>{`Driver's License`}</option>
          </select>
        {/* Dropdown Icon (Close to Text) */}
