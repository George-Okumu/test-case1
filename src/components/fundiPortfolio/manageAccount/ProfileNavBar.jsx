  ...
  return (
    <Card className="fixed top-0 left-0 h-screen w-full max-w-[20rem] p-4 shadow-xl rounded-r-xl bg-white border-r border-gray-200">
      ...
      <List className="space-y-2">
        <Link to="/fundi-portal/account-info">
        ...
        <Link to="/fundi-portal/account-uploads">
        ...
        <Link to="/fundi-portal/experience">
          <ListItem className={`hover:bg-blue-50 transition-all duration-200 ${isActiveRoute('/experience') ? 'bg-blue-50' : ''}`}>
            <ListItemPrefix>
        ...
        <Link to="/fundi-portal/products">
          <ListItem className={`hover:bg-blue-50 transition-all duration-200 ${isActiveRoute('/products') ? 'bg-blue-50' : ''}`}>
            <ListItemPrefix>
