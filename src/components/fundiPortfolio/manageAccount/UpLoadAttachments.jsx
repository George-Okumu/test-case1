      ...
      <div className="bg-white rounded-xl p-8">
        ...
        <form className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              <label className="w-full flex flex-col items-center px-4 py-6 bg-white rounded-lg border-2 border-dashed border-[rgb(0,0,122)] cursor-pointer hover:bg-gray-50">
                ...
                <span className="mt-2 text-sm text-gray-600">Drag and drop or click to upload Certificates</span>
                <input 
                  type="file" 
                  className="hidden" 
                  multiple 
          ...
          <div className="space-y-2">
            ...
            {certificates.length > 0 && (
              <div className="mt-4">
                <p className="text-sm font-medium text-[rgb(0,0,122)]">Selected Certificates:</p>
                <ul className="mt-2 space-y-1">
                  {certificates.map((file, index) => (
                    <li key={index} className="text-sm text-gray-600 flex justify-between items-center">
                      <span>{file.name}</span>
