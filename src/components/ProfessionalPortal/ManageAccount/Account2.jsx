      ...
      <div className="ml-80">
        <section className='w-full max-w-3xl p-6'>
          <div className='bg-white rounded-xl  p-8'>
            ...
            <div className='flex flex-col items-start mb-8'> {/* Changed to items-start */}
              <Avatar
                size="xl"
                alt="avatar"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 relative">
                    ...
                    <div className="flex items-center border-b focus-within:border-b-[rgb(0,0,122)] transition-all">
                      ...
                      <Link to="/findi-portal/account-info/edit-phone">
                        <FiEdit className="text-[rgb(0,0,122)] cursor-pointer hover:opacity-75" size={15} />
                      </Link>
                  ...
                  <div className="space-y-2 relative">
                    ...
                    <div className="flex items-center border-b focus-within:border-b-[rgb(0,0,122)] transition-all">
                      <input
                        type="email"
                        defaultValue="Professional@jagedo.com"
                        className="w-full px-4 py-2 outline-none"
                      />
