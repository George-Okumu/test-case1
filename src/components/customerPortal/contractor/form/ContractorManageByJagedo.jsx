...
const ContractorManageByJagedo = () => (
    <form className="mx-auto bg-white md:px-8 px-4 py-4 md:py-8 rounded-lg shadow-lg space-y-6 border border-gray-200">
        {/* Title */}
        <h2 className="text-2xl font-bold text-[rgb(0,0,122)] text-center font-['Roboto Serif',serif]">Request Contactor</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
                {/* Skill */}
                <div>
                    <label htmlFor="skill" className="block text-gray-800 font-semibold mb-1">Contractor:</label>
                    <select
                        id="skill"
                        name="skill"
                        className="w-full px-4 py-2 border border-black rounded-md text-gray-700 focus:ring-2 focus:ring-[rgb(0,0,122)]"
                    >
                        <option className="text-gray-500" value="">Select Contactor</option>
        ...
        <div className="flex justify-center my-2.5">
            <div className="flex">
                <input type="checkbox" />
                <span className="ml-2 underline font-semibold hover:text-[rgb(0,0,122)]">I agree to Contractor Agreement</span>
            </div>
        </div>
