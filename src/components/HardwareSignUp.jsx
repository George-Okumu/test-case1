...
const HardwareSignUp = () => {
  const [selectedTypes, setSelectedTypes] = useState([]);
      ...
      const getBackgroundColor = (state) => {
        ...
        if (state?.isFocused) return 'rgb(169, 169, 169)';
        return 'transparent';
      };
...
/>
            ...
            {/* Navigation Buttons */}
            <div className="pl-2  flex gap-x-42 w-full max-w-sm mt-6">
  ...
  >
    Resend OTP
              ...
              {step === 6 && (
  <div className="font-roboto mt-19 p-8 bg-white rounded-3xl shadow-xl w-full max-w-lg mx-auto border border-gray-200">
  {/* Section Title */}
  <h3 className="text-xl font-bold text-[rgb(0,0,122)] mb-6 text-center tracking-wide">
